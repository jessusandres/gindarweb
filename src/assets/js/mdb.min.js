...
const mdbMinPlugin = () => {
  ...
  }), jQuery.Velocity ? function(){} : (function (t) {
    function e(t) {
          ...
          function o() {
            function t(t) {
              ...
              function g() {
                ...
                }, n = t.position === L.lastPosition && t.myParent === L.lastParent, a = t.fontSize === L.lastFontSize;
      ...
      1: [function (t, e, i) {
        ...
        n._set("bar", {
          ...
          t.controllers.bar = t.DatasetController.extend({
            dataElementType: a.Rectangle, initialize: function () {
              ...
              var i, n, a, r, o, s, l = this.chart, u = this.getMeta(), d = this.getValueScale(), c = l.data.datasets,
                h = d.getRightValue(c[t].data[e]), f = d.options.stacked, p = u.stack, g = 0;
              ...
              var n = i.scale.options, a = "flex" === n.barThickness ? function (t, e, i) {
                ...
                }(e, i, n), o = this.getStackIndex(t, this.getMeta().stack), s = a.start + a.chunk * o + a.chunk / 2,
            ...
            dataElementType: a.Arc, linkScales: r.noop, getRingIndex: function (t) {
              ...
              if (f < 2 * Math.PI) {
                var p = a.rotation % (2 * Math.PI),
                  ...
                  w = p <= .5 * -Math.PI && .5 * -Math.PI <= g || p <= 1.5 * Math.PI && 1.5 * Math.PI <= g, k = h / 100,
                  S = {
              ...
              var n = this, a = n.chart, o = a.chartArea, s = a.options, l = s.animation, u = (o.left + o.right) / 2,
                d = (o.top + o.bottom) / 2, c = s.rotation, h = s.rotation, f = n.getDataset(),
              ...
              var b = t._model, y = t.custom || {}, x = r.valueAtIndexOrDefault, w = this.chart.options.elements.arc;
        ...
        n._set("line", {
          ...
          t.controllers.line = t.DatasetController.extend({
            datasetElementType: a.Line, dataElementType: a.Point, update: function (t) {
              ...
              var n, a, o = this, s = o.getMeta(), l = t.custom || {}, u = o.getDataset(), d = o.index, c = u.data[e],
                h = o.getScaleForId(s.yAxisID), f = o.getScaleForId(s.xAxisID), p = o.chart.options.elements.point;
              ...
              var t, i = this.chart, n = this.getMeta(), a = n.data || [], o = i.chartArea, s = a.length, l = 0;
        ...
        n._set("polarArea", {
          ...
          t.controllers.polarArea = t.DatasetController.extend({
            dataElementType: a.Arc, linkScales: r.noop, update: function (t) {
              ...
              var b = this.chart.options.elements.arc, y = t.custom || {}, x = r.valueAtIndexOrDefault, w = t._model;
        ...
        e.exports = function (t) {
          ...
          t.types = {}, t.instances = {}, t.controllers = {}, o.extend(t.prototype, {
            construct: function (e, i) {
              ...
              var t = this, i = t.options, n = t.scales || {}, a = [], r = Object.keys(n).reduce(function (t, e) {
                return t[e] = !1, t
              }, {});
        ...
        e.exports = function () {
          ...
          r.configMerge = function () {
            ...
            var a = t.skip ? e : t, r = e, o = i.skip ? e : i,
              ...
              c = n * (u = isNaN(u) ? 0 : u), h = n * (d = isNaN(d) ? 0 : d);
            return {
          ...
          defaults: {}, addBox: function (t, e) {
            ...
            if (t) {
              var o = t.options.layout || {}, s = n.options.toPadding(o.padding), l = s.left, u = s.right, d = s.top,
                c = s.bottom, h = a(t.boxes, "left"), f = a(t.boxes, "right"), p = a(t.boxes, "top"),
                g = a(t.boxes, "bottom"), m = a(t.boxes, "chartArea");
        ...
        n._set("scale", {
          ...
          fit: function () {
            ...
            if (a.display && h) {
              var v = r.longestText(t.ctx, p.font, i, t.longestTextCache), b = r.numberOfLabelLines(i), y = .5 * p.size,
          ...
          draw: function (t) {
            ...
            if (i.display) {
              var a = e.ctx, o = n.global, s = i.ticks.minor, u = i.ticks.major || s, h = i.gridLines, f = i.scaleLabel,
                p = 0 !== e.labelRotation, g = e.isHorizontal(),
                m = s.autoSkip ? e._autoSkip(e.getTicks()) : e.getTicks(),
                v = r.valueOrDefault(s.fontColor, o.defaultFontColor), b = d(s),
                y = r.valueOrDefault(u.fontColor, o.defaultFontColor), x = d(u), w = h.drawTicks ? h.tickMarkLength : 0,
                k = r.valueOrDefault(f.fontColor, o.defaultFontColor), S = d(f), C = r.options.toPadding(f.padding),
                M = r.toRadians(e.labelRotation), P = [], T = e.options.gridLines.lineWidth,
        ...
        (e.exports = a.extend({
          initialize: function () {
            ...
            var n, a, r, o, s, l, u = i.caretSize, d = i.cornerRadius, c = i.xAlign, h = i.yAlign, f = t.x, p = t.y,
        ...
        n._set("global", {
          ...
          inRange: function (t, e) {
            ...
            var e = this._view, i = this._model, a = this._chart.ctx, s = e.pointStyle, l = e.rotation, u = e.radius,
              d = e.x, c = e.y;
        ...
        var u = a.extend({
          initialize: function (t) {
            ...
            var t = this, e = t.options, i = e.labels, a = e.display, o = t.ctx, s = n.global, u = r.valueOrDefault,
              d = u(i.fontSize, s.defaultFontSize), c = u(i.fontStyle, s.defaultFontStyle),
              h = u(i.fontFamily, s.defaultFontFamily), f = r.fontString(d, c, h), p = t.legendHitBoxes = [],
              g = t.minSize, m = t.isHorizontal();
        ...
        var l = a.extend({
          ...
          fit: function () {
            var t = this, e = r.valueOrDefault, i = t.options, a = i.display,
              o = e(i.fontSize, n.global.defaultFontSize), s = t.minSize, l = r.isArray(i.text) ? i.text.length : 1,
              u = r.options.toLineHeight(i.lineHeight, o), d = a ? l * u + 2 * i.padding : 0;
          ...
          draw: function () {
            ...
            if (a.display) {
              var s, l, u, d = i(a.fontSize, o.defaultFontSize), c = i(a.fontStyle, o.defaultFontStyle),
                ...
                p = r.options.toLineHeight(a.lineHeight, d), g = p / 2 + a.padding, m = 0, v = t.top, b = t.left,
                y = t.bottom, x = t.right;
        ...
        e.exports = function () {
          var t = o.extend({
            initialize: function () {
              ...
              var t, e, i, a, o, s, d = this, c = d.chart, p = d.options.time, g = p.unit || "day", v = u, b = l,
                y = [], x = [], w = [];
              ...
              var a = this.options, o = t.valueOf(), s = a.time.displayFormats, l = s[this._unit], u = this._majorUnit,
                d = s[u], c = t.clone().startOf(u).valueOf(), h = a.ticks.major, f = h.enabled && u && d && o === c,
                p = t.format(n || (f ? d : l)), g = f ? h : a.ticks.minor,
              ...
              var e = this, i = e.options.time.displayFormats.millisecond, a = e.tickFormatFunction(n(t), 0, [], i),
                r = e.getLabelWidth(a), o = e.isHorizontal() ? e.width : e.height, s = Math.floor(o / r);
              return s > 0 ? s : 1
            }
          });
